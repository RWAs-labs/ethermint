...
SIMAPP = ./app
HTTPS_GIT := https://github.com/RWAs-labs/ethermint.git
...
PACKAGE_NAME:=github.com/RWAs-labs/ethermint
...
godocs:
	@echo "--> Wait a few seconds and visit http://localhost:6060/pkg/github.com/RWAs-labs/ethermint/types"
	godoc -http=:6060
...
test-import:
	go test -run TestImporterTestSuite -v --vet=off github.com/RWAs-labs/ethermint/tests/importer
